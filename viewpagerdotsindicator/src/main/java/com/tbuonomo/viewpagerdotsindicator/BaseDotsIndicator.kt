...
abstract class BaseDotsIndicator @JvmOverloads constructor(context: Context,
    ...
    internal lateinit var photos: MutableList<Pair<Profile.Photo.Type?, String?>>
    ...
    fun setViewPager2(viewPager2: ViewPager2) {
        ...
        if (viewPager2.adapter is DotIndicator) {
            photos = (viewPager2.adapter as DotIndicator).getPhotos()
        }
